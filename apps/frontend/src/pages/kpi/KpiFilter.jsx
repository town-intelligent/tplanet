...
import { SITE_HOSTERS, sdgData } from "../../utils/Config";
    ...
    const fetchProjects = async () => {
      try {
        ...
        for (const email of hosters) {
          const listResp = await list_plans(email); // { result: "true", projects: ["..."] }
          if (Array.isArray(listResp?.projects)) {
            listResp.projects.forEach((u) => uuidSet.add(u));
          }
        }
