...
export const getSroiDataMeta = async (uuid) => {
  try {
    ...
    const response = await fetch(`${import.meta.env.VITE_HOST_URL_TPLANET}/projects/get_sroi_meta`, {
      method: "POST",
      body: form,
    });
...
export const getSroiData = async (uuid) => {
  try {
    ...
    const response = await fetch(`${import.meta.env.VITE_HOST_URL_TPLANET}/projects/get_sroi`, {
      method: "POST",
      body: form,
    });
...
export const setSroiData = async (uuid, visible = true) => {
  try {
    ...
    const response = await fetch(`${import.meta.env.VITE_HOST_URL_TPLANET}/projects/set_sroi`, {
      method: "POST",
      body: form,
    });
